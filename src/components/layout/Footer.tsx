      ...
      <div className="container footer-container">
        <div className="footer-brand">
          <a href="#" className="footer-logo" onClick={handleScrollToTop}>
            <img src="/media/icons/viora-text-only.svg" alt="Viora Elite" />
          </a>
        ...
        <div className="footer-content">
          ...
          <div className="footer-right">
            <div className="footer-column footer-socials">
              <a href="https://www.instagram.com/viora.elite?stkn=dGN2ZHVtdnJ4bmF2" className="footer-link" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
